...
const ChatScreenRSideBar: React.FC<ChatScreenRSideBarProps> = ({
  ...
  return (
    <>
      ...
      <div className={`absolute py-8 top-0 z-40 w-12 h-full bg-gray-100 flex flex-col items-center py-8 gap-2 border-l border-gray-200 transition-all duration-300 ${rightSidebarOpen ? 'right-[480px]' : 'right-0'}`}>
        <button
          onClick={onToggle}
        ...
        <button className="p-2 hover:bg-gray-200 rounded-lg transition-colors text-gray-600" title="Context">
          <BookOpen size={16} />
        </button>
        <button className="p-2 hover:bg-gray-200 rounded-lg transition-colors text-gray-600" title="Settings">
          <Settings size={16} />
        </button>
        <button className="p-2 hover:bg-gray-200 rounded-lg transition-colors text-gray-600" title="Tools">
          <Wrench size={16} />
        </button>
      </div>
              ...
              <div className="space-y-4">
                ...
                <div className="border-2 border-green-500 rounded-lg p-4 bg-green-50">
                  <textarea
                    ...
                    className="w-full h-64 p-3 text-gray-700 bg-white border-0 rounded-lg resize-none focus:outline-none"
                  />
                ...
                <div className="flex justify-end gap-3">
                  <button onClick={onCancelAddInstruction} className="px-6 py-2 text-gray-700 bg-gray-200 rounded-lg hover:bg-gray-300 transition-colors">
                    Cancel
                  </button>
                  <button
                    ...
                    className={`px-6 py-2 text-white rounded-lg transition-colors ${
                      instructionText?.trim() && instructionName?.trim() ? 'bg-green-600 hover:bg-green-700' : 'bg-gray-400 cursor-not-allowed'
                    }`}
                  >
                    Add
                  </button>
