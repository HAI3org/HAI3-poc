        ...
        <div className="flex items-start justify-between mb-1">
          {isEditing ? (
            <input
              ...
              className="flex-1 px-2 py-1 text-sm rounded focus:outline-none focus:ring-2 mr-2"
              ref={(input) => {
                if (input) {
          ...
          <div className="flex items-center gap-1 ml-2">
            ...
            {isChatTemporary && isChatTemporary(chat.id) && (
              <div className="flex items-center" title="Temporary chat">
                <Clock size={12} className="text-red-500 opacity-80" />
              </div>
            )}
            ...
            <div className="absolute right-4 opacity-0 group-hover:opacity-100 transition-opacity duration-200 flex items-center gap-1 chat-action-buttons">
              <button
                ...
                className="p-1 hover:bg-gray-100 rounded transition-colors duration-200 bg-transparent transform hover:scale-110"
              ...
              <button
                ...
                onMouseDown={(e) => e.stopPropagation()}
                className="p-1 hover:bg-red-50 rounded transition-colors duration-200 bg-transparent transform hover:scale-110"
                title="Delete chat"
              >
